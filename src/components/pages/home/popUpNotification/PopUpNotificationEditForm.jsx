...
const PopUpNotificationEditForm = () => {
  ...
  useEffect(() => {
    // Fetch the existing pop-up notification details
    dispatch(getPopUpNotificationById(id))
      .then((response) => {
      ...
      .catch((err) => console.error("Error fetching pop-up notification:", err));
  }, [id, dispatch]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(updatePopUpNotification({ id, formData })).unwrap();
      setSubmitSuccess(true);
    } catch (err) {
      console.error("Failed to update pop-up notification:", err);
    }
  };
        ...
        <Container component="main" maxWidth="md">
          ...
          >
            <Alert severity="success" variant="filled">
              Pop-up notification updated successfully!
            </Alert>
          </Snackbar>
 ...
 <Box sx={{
                ...
                Edit Pop-Up Notification
                             ...
                             <Tooltip
                               title="This is where you can Edit the Popup Notification in Home page show"
                               arrow
                             >
                               <HelpOutline
...
export default PopUpNotificationEditForm;